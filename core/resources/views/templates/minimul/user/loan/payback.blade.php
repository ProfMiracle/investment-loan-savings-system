                            ...
                            <div class="tab-item active">
                                ...
                                <form action="" method="post">
                                    ...
                                    <div class="text-center">
                                        <h2 style="color: red">YOU OWE: NGN {{$loan->payback_amount??''}}</h2>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <select name="wallet" id="" class="form-control form-control-lg" required>
                                                ...
                                                <option value="deposit">Deposit ||{{$wallets[0]->balance}}</option>
                                                <option value="interest">Interest ||{{$wallets[1]->balance}}</option>
                                            </select>
                                        </div>
                                    </div>
