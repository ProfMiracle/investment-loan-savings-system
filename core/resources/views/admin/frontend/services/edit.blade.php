                                    ...
                                    <div class="image-upload">
                                        <div class="thumb">
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview" style="background-image: url({{ get_image(config('constants.frontend.services.path') .'/'. $testi->value->image) }})">
                                            ...
                                            <div class="avatar-edit">
                                                ...
                                                <small class="mt-2 text-facebook">Supported files: <b>png,</b>. Image will be resized into <b>{{ Config::get('constants.frontend.services.size') }}px</b> </small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.frontend.services.index') }}" class="btn btn-dark" ><i class="fa fa-fw fa-reply"></i>Back</a>
@endpush
